...
const dir = path.resolve('src/app/api/reli/instrumen/[id]');
...
fs.writeFileSync(path.join(dir, 'route.js'), content, 'utf8');
console.log('Created src/app/api/reli/instrumen/[id]/route.js in UTF8');
